...
if (!defined('APP_NAME'))                       define('APP_NAME', 'AI REVOLUTION');
if (!defined('APP_ORGANIZATION'))               define('APP_ORGANIZATION', 'AI REVOLUTION');
if (!defined('APP_OWNER'))                      define('APP_OWNER', 'AI REVOLUTION');
if (!defined('APP_DESCRIPTION'))                define('APP_DESCRIPTION', 'Construction Management');

if (!defined('ALLOWED_INACTIVITY_TIME'))        define('ALLOWED_INACTIVITY_TIME', time()+1*60);

if (!defined('DB_DATABASE'))                    define('DB_DATABASE', 'air');
